...
namespace BuiltinTypes
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine($"sbyte: minimum {sbyte.MinValue}, smaximum {sbyte.MaxValue}");
            //Console.WriteLine($"short: minimum {short.MinValue}, smaximum {short.MaxValue}");
            ...
            Console.WriteLine($"d is {d:F99}"); // more precise
